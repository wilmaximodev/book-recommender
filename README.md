...
Se você deseja executar testes unitários para garantir que a aplicação esteja funcionando corretamente, utilize o pytest. Os testes podem ser executados com o seguinte comando:

bash
Copy
Edit
pytest
Passo 7: Verificando o Histórico do Usuário
